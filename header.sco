...
;
; Warning! redundant, header.sco file in instr dir named for instr
; This file should be included in instrument score files as the first line:
; #include "header.sco"
; assuming the header is in the same directory as the score...
;
...
;; instr 43 - Cello
; NOTE: all this is now done in the score,
; just '#include data/Cello.arco.reference-1st/Cello.arco.refereence-1st-header.sco'
;; alternative s/b plucked. Substitute ftable 43 as required.

; instr 72 - Clarinet
;#include "data/Clarinet.Bb.data"
;#include "data/Clarinet.Bb-hmag.data"
...
f219	0	3	7		1 1 -1 1 1	; test 'linear cos tbl'
...
f230	0	3	7	0 1 1 1 0	; triangle: extended contour
f231	0	4	7	0 1 1 1 0	; triangle: interpolated wraparound
f232	0	3	7	1 1 0 1 1	; inv. triangle extended contour
f233	0	4	7	1 1 0 1 1	; inv. triangle: interpolated wraparound
...
;f246	0	2	16	0 2 0	; zero
;f247	0	2	16	1 2 0	; unity
f246	0	2	7	0 16 0	; zero
f247	0	2	7	1 16 1	; unity

f248	0	257	-7	2 143 0.05 113 0.05; portamento/frequency factor table

; redundant
; <<< transfer functions >>>
; 249 amplitude transfer fn - max. spectral change in
; most-used amplitudes (500 -> 20000)
;f249	0	256		7	0 153 0 91 1 12 1
; 250 frequency transfer fn - max. spectral change in
; most-used frequencies (30-5000 Hz)
;f250	0	256		7	0 87 0 131 1 38 1
...
; utility fns
f301	0	3	-7	0 1 1 1 0
f302	0	3	-7	1 1 0 1 1
...
; terrain functions
; 237 sine offset 1
;f237	0	257	19	1 1 0 1
; cos offset 1
;f237	0	257	19	1	1	90	1
